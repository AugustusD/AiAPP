package com.duanshl.aiapp.ui.recognition;
...
import com.duanshl.aiapp.ui.dashboard.DashboardViewModel;
...
public class CommonRecg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_recg);
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                if (isAndroidQ) {
                     ...
                     * 使用百度api进行植物识别
                     */
                    String path = getPath(getApplicationContext(),mCameraUri);
